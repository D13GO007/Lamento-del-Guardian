...
namespace UHFPS.Tools
{
    public static class GameTools
    {
        ...
        /// <summary>
        /// I don't understand whose idea it was to deprecate this function from HDAdditionalLightData, when setting the light intensity directly in a new way gives unexpected results.
        /// Maybe this will improve in the future, but for now you need to use this function to set the light intensity in given light unit.
        /// </summary>
        public static void SetIntensity(this Light light, float intensity, LightUnit unit = LightUnit.Lumen)
        {
        ...
        /// Set Emission State
        /// </summary>
        public static void SetEmission(this Renderer renderer, bool state, float intensity = 2f, string keyword = "_EmissiveColor")
        {
            Color color = state ? Color.white * intensity : Color.black;
            renderer.material.SetColor(keyword, color);
        }

        /// <summary>
        /// Set Emission State
        /// </summary>
        public static void SetEmission(this Material material, bool state, float intensity = 2f, string keyword = "_EmissiveColor")
        {
            Color color = state ? Color.white * intensity : Color.black;
            material.SetColor(keyword, color);
        }

        /// <summary>
        /// Set Emission State
        /// </summary>
        public static void SetEmission(this Renderer renderer, bool state, Color emissionColor, float intensity = 2f, string keyword = "_EmissiveColor")
        {
            Color color = state ? emissionColor * intensity : Color.black;
            renderer.material.SetColor(keyword, color);
        }
        ...
        /// Set Emission State
        /// </summary>
        public static void SetEmission(this Material material, bool state, Color emissionColor, float intensity = 2f, string keyword = "_EmissiveColor")
        {
            Color color = state ? emissionColor * intensity : Color.black;
            material.SetColor(keyword, color);
        }
